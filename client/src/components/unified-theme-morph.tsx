...
function ShowcaseGalleryContent() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="showcase-gallery py-20 min-h-screen flex items-center"
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        <div className="max-w-4xl">
          ...
          <h1
            className="text-white font-normal leading-[0.75] mb-12 text-left text-3xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl"
          ...
          >
            ...
            <div className="overflow-visible -mb-2 whitespace-nowrap">
          ...
          >
            ...
            <div className="text-white/90 text-base md:text-lg lg:text-xl font-normal leading-relaxed">
