...
export default function HeroSection() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-2 sm:px-3 lg:px-4 pt-20 md:pt-24">
        <div className="space-y-4 md:space-y-6">
          <div className="hero-line hero-text text-left flex items-baseline" data-testid="hero-line-1">
            <span className="hero-word mr-6" data-direction="left">TRANSFORMING</span>
            <div
              ref={image1Ref}
              className="inline-block w-12 h-12 md:w-16 md:h-16 rounded-full overflow-hidden mx-3 flex-shrink-0 relative top-2 hero-image"
            >
              <img
          ...
          <div className="hero-line hero-text text-left" data-testid="hero-line-2">
            <span className="hero-word mr-6" data-direction="left">INTO</span>
            <span className="hero-word" data-direction="right">REALITY</span>
          </div>
          <div className="hero-line hero-text text-left flex items-baseline" data-testid="hero-line-3">
            <span className="hero-word mr-6" data-direction="left">THROUGH</span>
            <div
              ref={image2Ref}
              className="inline-block w-16 h-10 md:w-20 md:h-12 rounded-lg overflow-hidden mx-3 flex-shrink-0 relative top-2 hero-image"
            >
              <img
          ...
          <div className="hero-line hero-text text-left" data-testid="hero-line-4">
            <span className="hero-word mr-6" data-direction="left">DESIGN &</span>
            <span className="hero-word" data-direction="right">3D PRINTING</span>
          </div>
        </div>

        <div className="mt-16 text-left">
          <div className="inline-flex items-center bg-black text-white px-4 py-6 rounded-full hover:bg-gray-800 transition-colors cursor-pointer">
            <span className="text-xs font-medium">LEARN MORE ABOUT OUR DESIGN & 3D PRINTING APPROACH</span>
